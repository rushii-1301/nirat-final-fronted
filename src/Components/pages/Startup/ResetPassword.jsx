                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <button
                                        ...
                                        className={`absolute right-4 top-1/2 -translate-y-1/2 p-1 rounded-lg transition-colors ${isDark ? "text-zinc-500 hover:text-zinc-300 hover:bg-zinc-700" : "text-zinc-400 hover:text-zinc-600 hover:bg-zinc-100"}`}
                                    >
