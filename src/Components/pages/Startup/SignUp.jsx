...
import { Upload, ChevronDown, CheckCircle2, X, Eye, EyeOff } from "lucide-react";
...
function SignUp({ theme = 'dark', isDark: isDarkProp }) {
        ...
        return (
            <div>
                ...
                <div
                    ...
                    className={`
                        ${isDragging === name ? (isDark ? "border-white/50 bg-white/5" : "border-gray-900/50 bg-gray-900/5") : (isDark ? "border-zinc-700 hover:border-zinc-600 bg-zinc-900/30" : "border-gray-300 hover:border-gray-400 bg-gray-50")}
                        border-2 border-dashed rounded-xl p-4 sm:p-6 cursor-pointer transition-all duration-300 relative overflow-hidden
                    `}
                >
                    <input
                        type="file"
                    ...
                    {values && values.length ? (
                        ...
                        <div className="text-center">
                            <div className={(isDark ? "bg-zinc-800" : "bg-gray-100") + " w-16 h-16 mx-auto mb-3 rounded-full flex items-center justify-center transition-transform duration-300 hover:scale-110"}>
                                <Upload className={(isDark ? "text-gray-300" : "text-gray-600") + " w-6 h-6"} />
                            </div>
                            <p className={(isDark ? "text-gray-200" : "text-gray-700") + " text-sm font-medium mb-1"}>
    ...
    const handleNextStep2 = (e) => {
        ...
        if (!educationFormData.educationCenterPhotos.length) missingFiles.push('Education Center Photos');
    ...
    const renderStep1 = () => (
        <form onSubmit={handleNextStep1} className="space-y-4 sm:space-y-5 animate-fadeIn">
            ...
            <div className="pt-3 sm:pt-4">
                <button
                    type="submit"
                    className={(isDark ? "bg-white text-black hover:bg-gray-100 hover:shadow-lg hover:shadow-white/20 active:scale-[0.98]" : "bg-gray-900 text-white hover:bg-black hover:shadow-xl active:scale-[0.98]") + " w-full font-bold text-sm sm:text-base uppercase tracking-wider rounded-xl py-3.5 sm:py-4 transition-all duration-300 transform hover:scale-[1.02] shadow-md cursor-pointer"}
                >
                    Next →
                </button>
            </div>
            ...
            <div>
                ...
                <div
                    ...
                    className={`
                        ...
                        rounded-xl p-4 sm:p-6 cursor-pointer transition-all duration-300 relative overflow-hidden
    ...
    const renderStep2 = () => (
        <form onSubmit={handleNextStep2} className="space-y-4 sm:space-y-5 animate-fadeIn">
            ...
            {/* Education Center Photos (multiple) */}
            <MultiFileUploadField
    ...
    return (
        <div className={(isDark ? "bg-linear-to-br from-black via-zinc-950 to-black" : "bg-linear-to-br from-gray-50 via-white to-gray-100") + " w-full h-screen flex flex-col lg:flex-row overflow-hidden fixed inset-0"}>
            ...
            <div className="lg:w-2/3 w-full flex items-start lg:items-center justify-center p-4 sm:p-5 md:p-6 lg:p-10 xl:p-12 h-[82vh] sm:h-[80vh] md:h-[78vh] lg:h-screen overflow-y-auto no-scrollbar pb-4 sm:pb-6 md:pb-8">
                <div className={(isDark ? "bg-zinc-800/90 backdrop-blur-sm border border-zinc-700/50 shadow-2xl shadow-black/50" : "bg-white/95 backdrop-blur-sm border border-gray-200/50 shadow-2xl shadow-gray-900/10") + " w-full max-w-2xl rounded-2xl p-5 sm:p-6 md:p-8 lg:p-10 xl:p-12 my-4 lg:my-auto transition-all duration-500"}>
                    {/* Step Indicator */}
                    <div className="mb-6 sm:mb-8">
                        <div className="flex items-center justify-center gap-2 mb-2">
                            <div className={`flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full ${currentStep >= 1 ? (isDark ? "bg-white text-black" : "bg-gray-900 text-white") : (isDark ? "bg-zinc-700 text-gray-400" : "bg-gray-200 text-gray-400")} font-bold text-xs sm:text-sm transition-all duration-300`}>
                                {currentStep > 1 ? <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5" /> : "1"}
                            </div>
                            <div className={`h-0.5 w-10 sm:w-12 ${currentStep >= 2 ? (isDark ? "bg-white" : "bg-gray-900") : (isDark ? "bg-zinc-700" : "bg-gray-200")} rounded-full transition-all duration-300`} />
                            <div className={`flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full ${currentStep >= 2 ? (isDark ? "bg-white text-black" : "bg-gray-900 text-white") : (isDark ? "bg-zinc-700 text-gray-400" : "bg-gray-200 text-gray-400")} font-bold text-xs sm:text-sm transition-all duration-300`}>
                                {currentStep > 2 ? <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5" /> : "2"}
                            </div>
                            <div className={`h-0.5 w-10 sm:w-12 ${currentStep >= 3 ? (isDark ? "bg-white" : "bg-gray-900") : (isDark ? "bg-zinc-700" : "bg-gray-200")} rounded-full transition-all duration-300`} />
                            <div className={`flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full ${currentStep >= 3 ? (isDark ? "bg-white text-black" : "bg-gray-900 text-white") : (isDark ? "bg-zinc-700 text-gray-400" : "bg-gray-200 text-gray-400")} font-bold text-xs sm:text-sm transition-all duration-300`}>
